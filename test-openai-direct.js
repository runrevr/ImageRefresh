/**
 * Test script for image transformation with the direct OpenAI method
 * Testing the gpt-image-1 model with direct file reading approach
 */
import fs from 'fs';
import path from 'path';
import { fileURLToPath } from 'url';
import { transformImage } from './server/openai-direct.js';
...
async function testTransformation() {
  try {
    console.log("Starting image transformation test with gpt-image-1 (direct method)");
    ...
    // Transform the image using gpt-image-1 model with our direct implementation
