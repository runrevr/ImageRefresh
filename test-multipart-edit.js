/**
 * Test script for the multipart/form-data implementation
 * Using OpenAI's gpt-image-1 model with the images/edits endpoint
 */
import fs from 'fs';
import path from 'path';
import { fileURLToPath } from 'url';
import { transformImage } from './server/openai-multipart-edit.js';
...
async function testImageEdit() {
  try {
    console.log("Starting multipart/form-data image edit test with gpt-image-1 model");
    ...
    // Transform the image using gpt-image-1 model with multipart/form-data
