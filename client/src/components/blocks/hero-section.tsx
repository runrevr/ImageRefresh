                            ...
                            <div className="mt-32 grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div className="bg-[#F2F2F2] rounded-[1.25rem] border border-gray-200 p-5 shadow-lg transition-all duration-300 hover:shadow-xl">
                                    <div className="flex flex-col space-y-4">
                                        ...
                                        {/* CTA Button */}
                                        <Link href="/prebuilt-prompts" className="mt-4 w-full bg-[#FF7B54] hover:bg-[#FF7B54]/90 text-white font-medium py-3 px-6 rounded-xl transition-colors inline-block text-center cursor-pointer">
                                            Explore Prompts
                                        </Link>
                                    </div>
                                </div>
