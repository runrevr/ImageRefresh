    ...
    return (
        <section className="py-24 relative overflow-hidden bg-light">
            <div className="mx-auto max-w-6xl px-6">
                <h2 className="text-center text-3xl font-medium text-charcoal mb-3">See what our AI can do</h2>
                <p className="text-center text-lg text-medium-gray/70 mb-12">From basic enhancements to complete transformations</p>
