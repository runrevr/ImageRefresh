    ...
    if (error) {
      ...
      try {
        ...
        toast({
          ...
          description:
            "Your payment was successful, but we couldn't add credits to your account. Please contact support.",
          variant: "destructive",
        });
      } finally {
        setIsLoading(false);
...
export default function StripeCheckout({
    ...
    const createPaymentIntent = async () => {
      try {
        ...
        toast({
          ...
          description:
            "We couldn't set up the payment form. Please try again later.",
          variant: "destructive",
        });
      }
    };
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <h3 className="text-xl font-semibold mb-4 text-[#FF7B54]">
        Purchase {creditAmount} Credits
      </h3>
      <p className="text-[#333333] mb-6">
        Each credit includes 1 image transformation and 1 edit. Your credits
