...
const ERA_STYLES: Record<EraSubcategory, StyleOption> = {
  "old-western": {
    ...
    suggestedPrompt:
      "Create a realistic, sepia-toned portrait inspired by the American frontier era (1860-1890). Capture the subject in authentic Western attire, such as a cowboy hat, bandana, vest, or prairie dress, reflecting the rugged lifestyle of the time. The background should evoke the dusty streets of a frontier town, with elements like wooden buildings, a saloon door, or a wide-open prairie. Use strong directional lighting that mimics the early days of photography, enhancing the atmosphere with shadows and texture to reflect the grit and resilience of the frontier. The final image should retain the clear likeness of the subject while maintaining historical accuracy in the clothing, props, and environment, creating an authentic and timeless Western portrait.",
  },
  "90s-hip-hop": {
    title: "90's Hip-Hop",
    description:
