...
const CARTOON_STYLES: Record<CartoonSubcategory, StyleOption> = {
  ...
  'dreamworks': {
    ...
    placeholder: 'E.g., Place the name Jack somewhere in the image',
    suggestedPrompt: 'Create a Troll (DreamWorks) style cartoon character inspired by this uploaded image. Choose a colorful Troll skin tone (e.g., blue, pink, purple) that complements the original image\'s palette. Maintain the general facial proportions and expression, with exaggerated Troll features like a large nose and big eyes. Style the teeth as small, rounded, and Troll-like, loosely based on the uploaded image\'s tooth appearance. Add vibrant, voluminous Troll hair and a compact, animated body. Ensure the output is playful, non-photorealistic, and suitable for a children\'s animated series.'
  },
  'princess': {
    title: 'Princess',
