...
const CARTOON_STYLES: Record<CartoonSubcategory, StyleOption> = {
  "super-mario": {
    ...
    suggestedPrompt:
      "Create a colorful 8-bit pixel art scene inspired by classic retro video games. Design a small pixel-style adventurer character with a playful, determined expression, sitting on a brown brick platform and holding a glowing orb. Dress the character in a green shirt and blue pants. Set the background with a bright solid blue sky, pixelated white clouds outlined in black, rolling green hills, rounded pixelated trees, and colorful flowers growing from floating brick blocks. Add a large green warp pipe with a red-and-green plant emerging from it, small turtle-like pixel creatures walking along the ground, and floating question mark blocks overhead. The overall style should feel bright, cheerful, energetic, and nostalgic, like a classic side-scrolling adventure world.",
  },
  minecraft: {
    title: "Minecraft",
