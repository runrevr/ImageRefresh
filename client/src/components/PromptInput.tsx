...
const CARTOON_STYLES: Record<CartoonSubcategory, StyleOption> = {
  "super-mario": {
    ...
    suggestedPrompt:
      " Create a colorful 8-bit pixel art scene inspired by classic retro video games. Design a small pixel-style adventurer character with a playful, confident pose, standing or sitting on a brown brick platform and holding a glowing orb. Dress the character in a bright green shirt and blue pants. The background features a vivid solid blue sky, pixelated white clouds outlined in black, rolling green hills, rounded pixelated trees, and colorful pixel flowers growing from floating brick blocks. Add a large green warp pipe with a red-and-green plant rising from it, small turtle-like pixel creatures walking nearby, and floating question mark blocks overhead. The overall style should feel cheerful, bright, energetic, and nostalgic, capturing the spirit of a classic side-scrolling adventure world.",
  },
  minecraft: {
    title: "Minecraft",
