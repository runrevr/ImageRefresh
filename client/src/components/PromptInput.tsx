...
export const CARTOON_STYLES: Record<CartoonSubcategory, StyleOption> = {
  "super-mario": {
    ...
    - Main plumber hero: Red cap with circular emblem, blue overalls with yellow buttons, white gloves, and brown boots. KEEP the exact same shirt/clothing they're wearing in the uploaded image underneath the overalls. KEEP THEIR ORIGINAL EYE COLOR from the uploaded image.
    - Secondary plumber hero: Green cap with circular emblem, blue overalls with yellow buttons, white gloves, and brown boots. KEEP the exact same shirt/clothing they're wearing in the uploaded image underneath the overalls. KEEP THEIR ORIGINAL EYE COLOR from the uploaded image.
    ...
    DO NOT CHANGE THE EYE COLOR - use the exact same eye color as shown in the original uploaded image. For males, preserve their original shirt/top under the overalls.
