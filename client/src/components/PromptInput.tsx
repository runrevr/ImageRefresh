...
const CARTOON_STYLES: Record<CartoonSubcategory, StyleOption> = {
  ...
  'dreamworks': {
    ...
    placeholder: 'E.g., Place the name Jack somewhere in the image',
    suggestedPrompt: 'The scene should be set in a vibrant, playful fantasy world inspired by DreamWorks Trolls, with oversized flowers, sparkling waterfalls, and candy-colored foliage. Transform into a custom Troll character that accurately matches real-life features. • Hair: Recreate the hairstyle using the closest matching Troll doll hair silhouette—tall, fluffy, and wildly colorful, with neon or pastel rainbow streaks that defy gravity. • Skin Tone: Use a Trolls palette (e.g. soft pastels or bright fantasy hues) but keep it faithful to the person\'s actual skin tone. • Eyes & Smile: Preserve natural eye color and visible dental traits (sparkle and shape of the teeth) for unmistakable likeness. • Clothing & Accessories: Dress the Troll in fun, textured garments true to the Trolls aesthetic—think flower crowns, glitter accents, or musical-instrument-inspired accessories. Ensure the Troll character is beaming with a joyful smile. The overall tone must remain colorful, whimsical, and imaginative—true to the DreamWorks Trolls universe, with full visual likeness preserved.'
  },
  'princess': {
    title: 'Princess',
  ...
  'superhero': {
    ...
    placeholder: 'E.g., Place the name Jack somewhere in the image',
    suggestedPrompt: 'Transform into a superhero version that maintains distinct facial features, expression, and body proportions while adding superhero elements. Outfit with a dynamic flowing cape and heroic costume featuring a custom emblematic chest symbol. Preserve unique characteristics, hairstyle, and identity while enhancing with a bold, colorful superhero uniform with contrasting colors. Place in a heroic stance within an urban environment with city skyline backdrop. Add subtle power effects surrounding hands or eyes suggesting unique abilities. The cape should billow dramatically to create a sense of movement and power. Maintain authentic appearance and individual features while elevating to superhero status with cinematic lighting and a powerful presence that captures the transformation from ordinary person to extraordinary hero.'
  },
  'lego': {
    title: 'Lego',
