...
const CARTOON_STYLES: Record<CartoonSubcategory, StyleOption> = {
  "super-mario": {
    ...
    suggestedPrompt:
      "Use the uploaded image only as inspiration for the pose, action, and attitude of a small pixel-style adventurer character. Create a colorful 8-bit pixel art scene inspired by classic retro video games. Design a cheerful [boy or girl] adventurer sitting or standing on a brown brick platform, holding a glowing orb. Dress the character in a green shirt and blue pants. The background should feature a vivid solid blue sky, pixelated white clouds outlined in black, rolling green hills, rounded pixelated trees, colorful pixel flowers on floating bricks, a large green warp pipe with a red-and-green plant, small turtle-like creatures, and floating question mark blocks. The overall style should feel bright, playful, nostalgic, and lively, inspired by classic side-scrolling adventure games. Do not copy real-world facial features or likeness from the uploaded image.",
  },
  minecraft: {
    title: "Minecraft",
