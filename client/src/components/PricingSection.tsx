...
const pricingTiers: PricingTier[] = [
  ...
  },
  {
    ...
    features: [
      ...
      {
        available: true,
        text: "All images created are stored in your account",
      },
    ],
    popular: false,
    ...
    <section id="pricing" className="mb-16">
          ...
          >
            ...
            <CardContent className="p-6 flex-grow flex flex-col">
              <div>
                ...
                <div className="text-4xl font-bold mb-6 text-[#333333]">
                  {tier.price}
                </div>
                <ul className="space-y-3">
                  {tier.features.map((feature, fIndex) => (
                    <li key={fIndex} className="flex items-start">
                      ...
                      <span
                        className={
                          feature.available ? "text-[#333333]" : "text-gray-400"
                        }
                      >
                        {feature.text}
                      </span>
      ...
      <div className="bg-gray-50 rounded-xl p-6 max-w-5xl mx-auto mt-8">
        ...
        <p className="text-gray-600 mb-4">
          You can purchase additional credits anytime at $1 each, with volume
          discounts available.
        </p>
        <Button
          variant="default"
