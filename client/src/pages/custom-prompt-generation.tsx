...
export default function CustomPromptGeneration() {
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-2 mb-4">
              <Plus className="h-8 w-8 text-[#06B6D4]" />
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900">
                Custom Prompt Generator
              </h1>
            </div>
            <p className="text-xl text-gray-600 mb-8">
              Describe your unique vision and let AI bring it to life
            </p>
            ...
            <div className="relative max-w-2xl mx-auto mb-12">
              <div className="relative">
                <Textarea
                  ...
                  placeholder="Be creative! Describe something unique and imaginative. Example: 'A floating castle made of crystallized music notes hovering above a sea of liquid starlight, with rainbow bridges connecting to smaller floating islands'"
