            ...
            <div className="w-full bg-gray-800 py-12 mt-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl mx-auto">
                <div className="bg-gray-800 p-6 rounded-xl flex flex-col items-center text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2 text-white">Product Photography</h3>
                  <p className="text-gray-300 mb-4">Transform everyday product shots into professional studio quality photos.</p>
                </div>
                ...
                <div className="bg-gray-800 p-6 rounded-xl flex flex-col items-center text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2 text-white">Cartoon Style</h3>
                  <p className="text-gray-300 mb-4">Convert your photos into vibrant, stylized cartoon illustrations.</p>
                </div>
                ...
                <div className="bg-gray-800 p-6 rounded-xl flex flex-col items-center text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2 text-white">Custom Transformations</h3>
                  <p className="text-gray-300 mb-4">Create any artistic style you can imagine with our advanced AI.</p>
                </div>
              </div>
            </div>
