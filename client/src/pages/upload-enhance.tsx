              ...
              <div key={step.id} className="flex items-center">
                <div className="flex items-center">
                  ...
                  <div className="ml-3 text-sm brand-font-body">
                    <p className={`font-medium ${step.id <= currentStep ? "text-gray-800" : "text-gray-500"}`}>
                      {step.name}
                    </p>
            ...
            <Card className={`brand-card ${hasImages ? '' : 'bg-gray-50'}`} style={{ 
              ...
              <CardContent className="space-y-8">
                ...
                <div className="space-y-4 max-w-2xl mx-auto">
                  <Label htmlFor="productType" className="brand-font-heading font-medium text-center block mb-6" style={{ color: '#8B5CF6' }}>
