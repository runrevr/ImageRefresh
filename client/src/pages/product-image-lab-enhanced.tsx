...
export default function ProductImageLabEnhancedPage() {
  const freeCredits = 1;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-semibold text-[#333333]">Sarah Johnson</p>
                    <p className="text-sm text-[#333333]/60">E-commerce Store Owner</p>
                  </div>
                </div>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="italic mb-4 text-[#333333]/80">"My product photos went from amateur to professional with just a few clicks. Amazing service that has significantly increased my conversion rates!"</p>
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-[#2A7B9B]/20 rounded-full mr-3 flex items-center justify-center text-[#2A7B9B] font-bold">M</div>
                  <div>
                    <p className="font-semibold text-[#333333]">Michael Chen</p>
                    <p className="text-sm text-[#333333]/60">Etsy Shop Owner</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-10 bg-[#F9F9F9]">
          <div className="mx-auto max-w-6xl px-6">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-semibold text-[#333333]">Trusted by businesses worldwide</h2>
            </div>
