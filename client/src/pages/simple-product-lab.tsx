...
export default function SimpleProductLabPage() {
      ...
      <main className="flex-grow pt-16">
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          <div className="text-center">
            ...
            <button className="py-3 px-8 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-medium rounded-lg text-lg">
              Get Started Now
            </button>
          </div>
        </div>
