    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-12 pt-20">
        <div className="mb-10 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-[#333333]">Help & Support</h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-16 text-center">
            <h2 className="text-2xl font-bold mb-4 text-[#333333]">Still have questions?</h2>
            <p className="text-lg text-[#333333] mb-6">
              If you can't find the answer you're looking for, please reach out to our support team.
            </p>
            <a 
              href="mailto:help@imagerefresh.com" 
