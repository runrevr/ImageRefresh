/**
 * Test script for the base64 direct implementation
 * Using OpenAI's gpt-image-1 model with the images/edit endpoint
 */
import fs from 'fs';
import path from 'path';
import { fileURLToPath } from 'url';
import { transformImage } from './server/openai-base64-direct.js';
...
async function testImageEdit() {
  try {
    console.log("Starting base64 direct image edit test with gpt-image-1 model");
    ...
    // Transform the image using gpt-image-1 model with direct base64 approach
