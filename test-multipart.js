/**
 * Test script for the multipart image transformation implementation
 * Using OpenAI's gpt-image-1 model with the images/edit endpoint
 */
import fs from 'fs';
import path from 'path';
import { fileURLToPath } from 'url';
import { transformImage } from './server/openai-multipart.js';
...
async function testImageEdit() {
  try {
    console.log("Starting multipart image edit test with gpt-image-1 model");
    ...
    // Transform the image using gpt-image-1 model with multipart approach
